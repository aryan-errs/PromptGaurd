/**
 * Vendored Unicode confusables subset — mirrors stages/_confusables.py.
 * Maps non-ASCII lookalike codepoints to their ASCII equivalents.
 * Only includes characters relevant to prompt-injection homoglyph attacks.
 */
